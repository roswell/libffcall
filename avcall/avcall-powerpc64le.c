#ifndef _avcall_powerpc64le_c				/*-*- C -*-*/
#define _avcall_powerpc64le_c
/**
...
/*----------------------------------------------------------------------
  ...
  PowerPC64 Little Endian Argument Passing Conventions:
  ...
  The ELF v2 argument passing conventions are used:
