...
register __varword arg5 __asm__("r22");
register __varword arg6 __asm__("r21");
register __varword arg7 __asm__("r20");
register __varword arg8 __asm__("r19");
...
register __varword iret __asm__("r28");
